...
def add_anchor_to_text(anchors_table, filter_table, text, anchored_keys):
    '''
    :param anchors_table:
    :param filter_table:
...
def do_anchor_text(test, interval):
    ...
    while True:
        ...
        #sql = "select id, content, answer from ask_question_data where id =140757784"
        ...
        for res in db_res:
            anchored_keys = []
            anchor_res= add_anchor_to_text(anchors_table, filter_table, res['content'], anchored_keys)
            ...
            for k in answers:
                if answers[k]["content"]:
                    ...
                    anchor_res= add_anchor_to_text(anchors_table, filter_table, answer_content, anchored_keys)
...
if __name__ == "__main__":
    ...
    for interval in intervals:
        p = multiprocessing.Process(target=do_anchor_remove, args=(args.test.upper(), interval))
        p.start()
