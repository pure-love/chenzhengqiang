...
def do_es_index(test, es_index, es_type, bulks):
    ...
    mongo_conn = MongoClient("10.5.0.18", 38000)

    param = {"analysis_data_120_5":"ask_1204m_5", 
             "analysis_data_120_6":"ask_1204m_6", 
             "analysis_data_xywy_5":"ask_xywy4m_1",
             "analysis_data_xywy_6":"ask_xywy4m_1"}
    ...
    for K in param:
        ...
        for res in ask_set.find(no_cursor_timeout = True):
            ...
            record = {
                    ...
                    #"type":0,
                    #"answer":json.dumps(res["answer"][0], ensure_ascii=False) if len(res["answer"]) > 0 else ""
                    }
                }
