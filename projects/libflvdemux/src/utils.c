...
AVCodec *getFlvCodec(){return &flv_decoder;}
AVCodec *getMp3Codec(){return &mp3_decoder;}
AVCodec *get264Codec(){return &h264_decoder;}
AVCodec *getFlvEncoder(){return &flv_encoder;}
#endif
