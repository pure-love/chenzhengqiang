...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1444540209, '7', './data/template/6_7_member_login.tpl.php', './template/yibai_city2', 'member/login')
