...
<!--[diy=diy1]--><div id="diy1" class="area"></div><!--[/diy]-->
        <!--论坛内容一-->
<div class="ybforum_mone">

   <!--轮播-->
 <div class="yb_forlb" id="slideBox">
  <!--[diy=diyyudi01]--><div id="diyyudi01" class="area"></div><!--[/diy]-->
  </div><!--轮播end-->
     <script type="text/javascript">jQuery(".yb_forlb").slide( { mainCell:".bd ul",effect:"left",easing:"easeOutQuart",delayTime:500,autoPlay:true} );</script>
  <div class="for_mor">
  <!--[diy=diyyudi02]--><div id="diyyudi02" class="area"></div><!--[/diy]-->
...
<div id="ct" class="wp cl<?php if($_G['setting']['forumallowside']) { ?> ct2<?php } ?> yudi_dz">
<?php if(empty($gid)) { ?>
    <div class="yb_forhy">
<div id="chart" class="bm bw0 cl" style="padding:0 20px;">
...
<!--论坛内容二-->
  ...
  <div class="for_mtr">
     ...
     <!--图文热点-->
     <div class="for_hot">
       <div class="for_hott">图文热点</div>
       <div class="for_hotb">
       <!--[diy=diyyibai011501]--><div id="diyyibai011501" class="area"></div><!--[/diy]-->
     ...
     <!--热帖排行-->
     <div class="for_rank">
       <div class="for_rankt">热帖排行</div>
       <div class="for_rankb">       
        <ul>
                <!--[diy=diyyibai011502]--><div id="diyyibai011502" class="area"></div><!--[/diy]-->
     ...
     <div class="for_topics">
       <div class="for_topicstt">活动专题</div>
       <div class="for_topicstb">       
        <!--[diy=diyyibai011503]--><div id="diyyibai011503" class="area"></div><!--[/diy]-->
