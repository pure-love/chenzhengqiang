...
0
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/header_common.htm', 1444537040, '7', './data/template/6_7_common_header_portal_index.tpl.php', './template/yibai_city2', 'common/header_portal_index')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/header_userstatus.htm', 1444537040, '7', './data/template/6_7_common_header_portal_index.tpl.php', './template/yibai_city2', 'common/header_portal_index')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/default/common/header_qmenu.htm', 1444537040, '7', './data/template/6_7_common_header_portal_index.tpl.php', './template/yibai_city2', 'common/header_portal_index')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/pubsearchform.htm', 1444537040, '7', './data/template/6_7_common_header_portal_index.tpl.php', './template/yibai_city2', 'common/header_portal_index')
;?>
