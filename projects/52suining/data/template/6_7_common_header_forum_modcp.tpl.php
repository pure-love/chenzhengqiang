...
0
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/header_common.htm', 1444542132, '7', './data/template/6_7_common_header_forum_modcp.tpl.php', './template/yibai_city2', 'common/header_forum_modcp')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/header_userstatus.htm', 1444542132, '7', './data/template/6_7_common_header_forum_modcp.tpl.php', './template/yibai_city2', 'common/header_forum_modcp')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/default/common/header_qmenu.htm', 1444542132, '7', './data/template/6_7_common_header_forum_modcp.tpl.php', './template/yibai_city2', 'common/header_forum_modcp')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/pubsearchform.htm', 1444542132, '7', './data/template/6_7_common_header_forum_modcp.tpl.php', './template/yibai_city2', 'common/header_forum_modcp')
;?>
