...
0
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/header_ajax.htm', 1444536922, '7', './data/template/6_7_forum_ajax.tpl.php', './template/yibai_city2', 'forum/ajax')
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/footer_ajax.htm', 1444536922, '7', './data/template/6_7_forum_ajax.tpl.php', './template/yibai_city2', 'forum/ajax')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
