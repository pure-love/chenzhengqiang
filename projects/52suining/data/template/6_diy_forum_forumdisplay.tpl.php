...
0
|| checktplrefresh('./template/yibai_city2/forum/forumdisplay.htm', './template/yibai_city2/forum/forumdisplay_leftside.htm', 1444538269, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/yibai_city2', 'forum/forumdisplay')
|| checktplrefresh('./template/yibai_city2/forum/forumdisplay.htm', './template/yibai_city2/forum/recommend.htm', 1444538269, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/yibai_city2', 'forum/forumdisplay')
|| checktplrefresh('./template/yibai_city2/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1444538269, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/yibai_city2', 'forum/forumdisplay')
|| checktplrefresh('./template/yibai_city2/forum/forumdisplay.htm', './template/yibai_city2/forum/forumdisplay_list.htm', 1444538269, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/yibai_city2', 'forum/forumdisplay')
|| checktplrefresh('./template/yibai_city2/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1444538269, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/yibai_city2', 'forum/forumdisplay')
|| checktplrefresh('./template/yibai_city2/forum/forumdisplay.htm', './template/yibai_city2/forum/search_sortoption.htm', 1444538269, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/yibai_city2', 'forum/forumdisplay')
|| checktplrefresh('./template/yibai_city2/forum/forumdisplay.htm', './template/yibai_city2/forum/search_sortoption.htm', 1444538269, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/yibai_city2', 'forum/forumdisplay')
;?><?php include template('common/header'); $_G[forum][description_short] = cutstr($_G[forum][description], 50);?><?php if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css"></style>
<!--[diy=diynavtop]--><div id="diynavtop" class="area"></div><!--[/diy]-->
<div id="pt" class="bm cl">
<div class="z"> <a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><em>&raquo;</em><a href="forum.php"<?php if($_G['setting']['forumjump']) { ?> id="fjump" onmouseover="delayShow(this, 'showForummenu(<?php echo $_G['fid'];?>)');" class="showmenu" <?php } ?>><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> </div>
...
<div class="bm bmw"><!-- 推荐主题 -->
<div class="cl"> <div class="z yibai_fdtt">推荐主题</div>
<?php if($_G['forum']['recommendlist']['images'] && $_G['forum']['modrecommend']['imagenum']) { ?>
<div class="z yibai_pro_promo yibai_fdtp">
<div class="bd">
...
<div class="hd">
<ul class="cl yibai_tir"></ul>
</div>
<script type="text/javascript">jQuery(".yibai_fdtp").slide({titCell:".yibai_tir",mainCell:".bd ul",autoPage:true,effect:"fold",autoPlay:true}); </script>
</div>
<ul class="z cl w6 mbm yibai_fdtl <?php if(!$_G['forum']['allowside']) { ?>k<?php } ?>">
<?php } else { ?>
<ul class="z cl w8 mbm yibai_fdtl <?php if(!$_G['forum']['allowside']) { ?>k<?php } ?>">
<?php } unset($_G['forum']['recommendlist']['images']);?><?php if(is_array($_G['forum']['recommendlist'])) foreach($_G['forum']['recommendlist'] as $rtid => $recommend) { ?><li class="yibai_bgimg"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $rtid;?>" <?php echo $recommend['subjectstyles'];?> target="_blank"><?php echo $recommend['subject'];?></a></li>
<?php } ?>
</ul>
...
<?php } ?> 
      ...
      <div class="bm bmw fl<?php if($_G['forum']['forumcolumns']) { ?> flg<?php } ?>">
        <div class="bm_h cl"> <span class="o"><img id="recommendgroups_<?php echo $_G['forum']['fid'];?>_img" src="<?php echo IMGDIR;?>/<?php echo $collapseimg['recommendgroups'];?>" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('recommendgroups_<?php echo $_G['forum']['fid'];?>');" /></span>
        ...
        <div class="bm_c" id="recommendgroups_<?php echo $_G['forum']['fid'];?>" style="<?php echo $collapse['recommendgroups'];?>">
          <table cellspacing="0" cellpadding="0" class="fl_tb">
            <?php if(is_array($recommendgroups)) foreach($recommendgroups as $key => $group) { ?> 
            <?php if($_G['forum']['forumcolumns']) { ?> 
            ...
            <tr class="fl_row"> 
              <?php } ?> 
              <?php } ?>
              <td class="fl_g"><div class="fl_icn_g"> <a href="forum.php?mod=group&amp;fid=<?php echo $group['fid'];?>" title="<?php echo $group['name'];?>" target="_blank"><img src="<?php echo $group['icon'];?>" alt="<?php echo $group['name'];?>" width="32" /></a> </div>
                <dl>
            ...
            <tr <?php if($key != 0) { ?>class="fl_row"<?php } ?>>
              <td class="fl_icn"><a href="forum.php?mod=group&amp;fid=<?php echo $group['fid'];?>" title="<?php echo $group['name'];?>" target="_blank"><img src="<?php echo $group['icon'];?>" alt="<?php echo $group['name'];?>" width="32" /></a></td>
              <td><h2><a href="forum.php?mod=group&amp;fid=<?php echo $group['fid'];?>" target="_blank"><?php echo $group['name'];?></a><span class="xg1 xw0"> (<?php echo $group['membernum'];?> 人)</span></h2>
                <p><?php echo cutstr($group['description'], 100); ?></p></td>
              <td class="fl_i"><span class="xi2"><?php echo $group['threads'];?> 主题</span></td>
              <td class="fl_by"><div> 
                  <?php if(is_array($group['lastpost'])) { ?> 
                  <a href="forum.php?mod=redirect&amp;tid=<?php echo $group['lastpost']['tid'];?>&amp;goto=lastpost#lastpost" class="xi2"><?php echo cutstr($group['lastpost']['subject'], 30); ?></a> <cite><?php echo $group['lastpost']['dateline'];?> <?php if($group['lastpost']['author']) { ?><a href="home.php?mod=space&amp;username=<?php echo $group['lastpost']['encode_author'];?>"><?php echo $group['lastpost']['author'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?></cite> 
                  <?php } else { ?> 
      ...
      <div class="bm">
        <div class="ntc_l hm xi2"><strong><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>&amp;do=thread&amp;view=me&amp;type=thread&amp;from=&amp;filter=aduit">您有 <?php echo $threadmodcount;?> 个主题正等待审核中，点击查看</a></strong></div>
      </div>
      <?php } ?> 
      
      <?php if($livethread) { ?>
      <div id="livethread" class="tl bm bmw cl" style="padding:10px 15px;">
        <div class="livethreadtitle vm"> <span class="replynumber xg1">回复 <span id="livereplies" class="xi1"><?php echo $livethread['replies'];?></span></span> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $livethread['tid'];?>" target="_blank"><?php echo $livethread['subject'];?></a> <img src="<?php echo IMGDIR;?>/livethreadtitle.png" /> </div>
...
<?php } ?></div>
              ...
              <p class="ptm pnpost" style="margin-bottom:10px;">
                <button type="submit" name="replysubmit" class="pn pnc vm" style="float:right;" value="replysubmit" id="livereplysubmit"> <strong>发表</strong> </button>
              </p>
            </div>
...
<?php if($subexists && $_G['page'] == 1) { include template('forum/forumdisplay_subforum'); } ?>
      ...
      <ul id="thread_types" class="ttp bm cl">
        ...
        <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?><?php if($_G['forum']['threadsorts']['defaultshow']) { ?>&amp;filter=sortall&amp;sortall=1<?php } if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">全部</a>
        </li>
        <?php if($_G['forum']['threadtypes']) { ?> 
        <?php if(is_array($_G['forum']['threadtypes']['types'])) foreach($_G['forum']['threadtypes']['types'] as $id => $name) { ?> 
       ...
       <!-- <li><span class="pipe">|</span></li>-->
        <?php } ?> 
        <?php if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $id => $name) { ?> 
        <?php if($_GET['sortid'] == $id) { ?>
...
<tbody>
<tr>
<td class="icn" style="text-align:center;"><img src="<?php echo IMGDIR;?>/ann_icon.gif" alt="公告" /></td>
<?php if($_G['forum']['ismoderator'] && !$_GET['archiveid']) { ?><td class="o">&nbsp;</td><?php } ?>
<th class="xs2">公告: <?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } ?></th>
<td class="by">
...
<div class="th showmenubox">
        <div class="y">
            ...
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=lastpost&amp;orderby=lastpost<?php echo $forumdisplayadd['lastpost'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'lastpost') { ?> xw1<?php } ?>">最新</a>&nbsp;
            <span class="pipe">|</span>
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=heat&amp;orderby=heats<?php echo $forumdisplayadd['heat'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'heat') { ?> xw1<?php } ?>">热门</a>&nbsp;
            <span class="pipe">|</span>
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="<?php if($_GET['filter'] == 'digest') { ?> xw1<?php } ?>">热帖</a>&nbsp;
            <span class="pipe">|</span>
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=digest&amp;digest=1<?php echo $forumdisplayadd['digest'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'digest') { ?> xw1<?php } ?>">精华</a>&nbsp;
            <span class="pipe">|</span>
            <?php if($_G['forum']['picstyle']) { ?> 
            <a <?php if(empty($_G['cookie']['forumdefstyle'])) { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=yes" class="chked"<?php } else { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=no" class="unchk"<?php } ?> title="图片模式浏览帖子">图片模式</a>  <span class="pipe">|</span>
            <?php } ?> 
            <span id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="atarget_1"<?php } else { ?>onclick="setatarget(1)"<?php } ?> title="在新窗口中打开帖子">新窗</span> 
        </div>

        筛选：
        <span class="showmenu_outer">
            <a id="filter_special" href="javascript:;" class="showmenu <?php if($_GET['specialtype']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">
                <?php if($_GET['specialtype'] == 'poll') { ?>
                投票
                <?php } elseif($_GET['specialtype'] == 'trade') { ?>
                商品
                <?php } elseif($_GET['specialtype'] == 'reward') { ?>
                悬赏
                <?php } elseif($_GET['specialtype'] == 'activity') { ?>
                活动
                <?php } elseif($_GET['specialtype'] == 'debate') { ?>
                辩论
                <?php } else { ?>
                全部主题
                <?php } ?>
        ...
        <span class="showmenu_outer">
            <a id="filter_time" href="javascript:;" class="showmenu <?php if($_GET['specialtype']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">
                <?php if(!$_GET['dateline']) { ?>
                全部时间
                <?php } elseif($_GET['dateline'] == '86400') { ?>
                一天
                <?php } elseif($_GET['dateline'] == '172800') { ?>
                两天
                <?php } elseif($_GET['dateline'] == '604800') { ?>
                一周
                <?php } elseif($_GET['dateline'] == '2592000') { ?>
                一个月
                <?php } elseif($_GET['dateline'] == '7948800') { ?>
                三个月
                <?php } else { ?>
                全部时间
                <?php } ?>
        ...
        排序：
        <span class="showmenu_outer">
            <a id="filter_orderby" href="javascript:;" class="showmenu <?php if($_GET['specialtype']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">
                <?php if($_GET['orderby'] == 'dateline') { ?>
                发帖时间
                <?php } elseif($_GET['orderby'] == 'replies') { ?>
                回复/查看
                <?php } elseif($_GET['orderby'] == 'views') { ?>
                查看
                <?php } elseif($_GET['orderby'] == 'lastpost') { ?>
                最后发表
                <?php } elseif($_GET['orderby'] == 'heats') { ?>
                热门
                <?php } else { ?>
                默认排序
                <?php } ?>
...
<a id="filter_reward" href="javascript:;" class="showmenu xi2<?php if($_GET['rewardtype']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">
                                <?php if($_GET['rewardtype'] == '') { ?>
                                全部悬赏
                                <?php } elseif($_GET['rewardtype'] == '1') { ?>
                                进行中
                                <?php } elseif($_GET['rewardtype'] == '2') { ?>
                                已解决
                                <?php } ?>
                            </a>&nbsp;
<?php } ?>
...
<th><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版块主题</a><?php } else { ?>&nbsp;<?php } ?></th><td>&nbsp;</td><td>&nbsp;</td><td style="border-right: 1px solid #F3F3F3;">&nbsp;</td>
</tr>
</tbody>
...
<tr>
<td class="icn">
                                    <div class="usrtou <?php if($thread['folder'] == 'lock' || $thread['special'] || $thread['displayorder']) { ?>s_lnoavatar<?php } ?>"> 
                                    <a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1">
                                    <?php echo avatar($thread[authorid],small);?> 
                                      </a>
                                      </div>
                                      </td>
...
<?php } ?>
<th class="<?php echo $thread['folder'];?> timubiao">
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/jrecommend_<?php echo $thread['recommendicon'];?>.gif" align="absmiddle" alt="recommend" title="评价指数 <?php echo $thread['recommends'];?>" />
<?php } if($thread['heatlevel']) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
...
<?php } else { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/folder_<?php echo $thread['folder'];?>.gif" />
<?php } ?>
</a>
...
<?php } } ?>
                                        ...
                                        <div class="forumsummary">
                                          <?php if(!empty($_G['setting']['pluginhooks']['jeavi_summary'][$key])) echo $_G['setting']['pluginhooks']['jeavi_summary'][$key];?>
                                        </div>  
                                        <div class="foruminfo"> 
                                        <i class="z">
                                        <?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?>
                                        楼主:<a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1">
                                      <span><?php echo $thread['author'];?></span></a><span><?php echo $thread['dateline'];?></span><span class="pipe">|</span>
                                        最后发表:
...
<?php echo $thread['lastpost'];?>
                                        ...
                                        <i class="y">
                                        <span class="ico_reply"><?php echo $thread['allreplies'];?></span>
                                       <span class="ico_see"><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></span>
                                        </i>
...
<?php if(!IS_ROBOT) { ?>
<div id="filter_special_menu" class="p_pop showsub" style="display:none" change="location.href='forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&filter='+$('filter_special').value">
<ul>
...
<div id="filter_reward_menu" class="p_pop showsub" style="display:none" change="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype='+$('filter_reward').value">
<ul>
...
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_postbutton_bottom'])) echo $_G['setting']['pluginhooks']['forumdisplay_postbutton_bottom'];?>
      ...
      <!--[/diy]--> 
      <?php if($fastpost) { ?> 
      <?php include template('forum/forumdisplay_fastpost'); ?> 
      <?php } ?> 
...
<dl class="forum-logo">
<dt> <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><img src="<?php if($_G['forum']['icon']) { ?>data/attachment/common/<?php echo $_G['forum']['icon'];?><?php } else { ?>template/yibai_city1/style/nopic.png<?php } ?>" alt="<?php echo $_G['forum']['name'];?>"></a> </dt>
<dd>
<h3><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" target="_blank"><?php echo $_G['forum']['name'];?></a></h3>
<p title="<?php echo $_G['forum']['description'];?>"><?php echo $_G['forum']['description_short'];?></p>
</dd>
</dl>
<p class="forum-info">今日：<em class="color3"><?php echo $_G['forum']['todayposts'];?></em>&nbsp;<i class="pipe">|</i>&nbsp;主题：<em class="color3"><?php echo $_G['forum']['threads'];?></em>&nbsp;<i class="pipe">|</i>&nbsp;排名: <em class="color3"><?php echo $_G['forum']['rank'];?></em> </p>
            <?php if($moderatedby) { ?>
            <p class="forum-info" style="margin-top:5px;">版主：<?php echo $moderatedby;?></p>
            <?php } ?>
</div>
<div class="group_mod clearall">
<div class="group-btn-bd"> 
<a class=" reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复" rel="nofollow">回复</a>
<a class="record"  href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" rel="nofollow">收藏</a>
...
<a class="post" id="newspecial"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖" rel="nofollow">发帖</a> </div>
</div>
<script>
...
<div class="t-widget shadow">
    ...
    <div class="board-show">
          <!--[diy=diyrigth01]--><div id="diyrigth01" class="area"></div><!--[/diy]-->
