...
0
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/header_common.htm', 1444537050, '7', './data/template/6_7_common_header_home_space.tpl.php', './template/yibai_city2', 'common/header_home_space')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/header_userstatus.htm', 1444537050, '7', './data/template/6_7_common_header_home_space.tpl.php', './template/yibai_city2', 'common/header_home_space')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/default/common/header_qmenu.htm', 1444537050, '7', './data/template/6_7_common_header_home_space.tpl.php', './template/yibai_city2', 'common/header_home_space')
|| checktplrefresh('./template/yibai_city2/common/header.htm', './template/yibai_city2/common/pubsearchform.htm', 1444537050, '7', './data/template/6_7_common_header_home_space.tpl.php', './template/yibai_city2', 'common/header_home_space')
;?>
